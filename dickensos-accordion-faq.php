...
/**
 * Plugin Name:       Accordion Creator
 * Description:       Accordion Creator plugin allows you add, manage and display Accordion on your wordpress website. This plugin is created with custom post type.
 * Version:           1.1
 ...
 * @since    1.0.0
 */
function run_dickensos_accordion() {

	$plugin = new Dickensos_Accordion();
	$plugin->run();

}
run_dickensos_accordion();
